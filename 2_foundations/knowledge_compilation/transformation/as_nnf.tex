...
% \begin{longtable}{@{}lp{0.142\textwidth}p{0.142\textwidth}p{0.142\textwidth}p{0.142\textwidth}p{0.142\textwidth}p{0.142\textwidth}@{}}
% \keepXColumns
% \begin{tabularx}{\textwidth}{@{}l*{6}{X}@{}}
% \caption{Properties of selected target languages.}%
% \label{tbl:kc_language_properties}\\
% \toprule
% \textbf{Form} & \textbf{Decomposable} & \textbf{Deterministic} & \textbf{Smooth} & \textbf{Structured Decomposability} & \textbf{Strong Determinism} & \textbf{Flat} \\
% \midrule
% \endfirsthead

% \multicolumn{7}{c}{\textit{Continued: Properties of selected target languages.}}\\
% \toprule
% \textbf{Form} & \textbf{Decomposable} & \textbf{Deterministic} & \textbf{Smooth} & \textbf{Structured Decomposability} & \textbf{Strong Determinism} & \textbf{Flat} \\
% \midrule
% \endhead
...
% NNF    & $\bot$ & $\bot$ & $\bot$ & $\bot$ & $\bot$ & $\bot$ \\
% CNF    & $\bot$ & $\bot$ & $\bot$ & $\bot$ & $\bot$ & $\top$ \\
% DNF    & $\top$ & $\top$ & $\bot$ & $\bot$ & $\bot$ & $\top$ \\
% DNNF   & $\top$ & $\bot$ & $\bot$ & $\bot$ & $\bot$ & $\bot$ \\
% d-DNNF & $\top$ & $\top$ & $\bot$ & $\bot$ & $\bot$ & $\bot$ \\
% SDD    & $\top$ & $\top$ & $\top$ & $\top$ & $\top$ & $\bot$ \\
% OBDD   & $\top$ & $\top$ & $\top$ & $\top$ & $\top$ & $\bot$ \\
...
%     \midrule
%         CNF & Universal & coNP-c & poly-delay & \#P-hard & coNP-c & polytime & coNP-c. & polytime \\ \hline
%         DNF & Universal & polytime & poly-delay & \#P-hard & coNP-c & polytime & coNP-c. & polytime \\ \hline
%         NNF & Universal & NP-c & NP-c & \#P-hard & coNP-c & polytime & coNP-c. & polytime \\ \hline
%         DNNF & Universal & polytime & poly-delay & \#P-hard & coNP-c & polytime & coNP-c. & polytime \\ \hline
%         d-DNNF & Less succinct & polytime & poly-delay & polytime & coNP-c & polytime & coNP-c. & polytime \\ \hline
